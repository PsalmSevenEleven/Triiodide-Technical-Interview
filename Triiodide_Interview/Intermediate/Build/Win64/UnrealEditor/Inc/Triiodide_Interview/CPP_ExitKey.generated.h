...
#ifdef TRIIODIDE_INTERVIEW_CPP_ExitKey_generated_h
#error "CPP_ExitKey.generated.h already included, missing '#pragma once' in CPP_ExitKey.h"
#endif
...
public: \
	DECLARE_CLASS(ACPP_ExitKey, AActor, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/Triiodide_Interview"), NO_API) \
...
#define FID_Triiodide_Interview_Source_Triiodide_Interview_CPP_ExitKey_h_14_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, ACPP_ExitKey); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(ACPP_ExitKey); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API ACPP_ExitKey(ACPP_ExitKey&&); \
	NO_API ACPP_ExitKey(const ACPP_ExitKey&); \
public:
...
template<> TRIIODIDE_INTERVIEW_API UClass* StaticClass<class ACPP_ExitKey>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID FID_Triiodide_Interview_Source_Triiodide_Interview_CPP_ExitKey_h
